...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ayk-j/Desktop/Motor Sequence Learning_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    line3 = visual.Rect(
        ...
        width=(100, 10)[0], height=(100, 10)[1],
        ori=90.0, pos=(50, 0), draggable=True, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor='white', fillColor='white',
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('Motor sequence/sequence_con.csv'), 
        seed=None, 
    )
    ...
    for thisTrial_2 in trials_2:
        ...
        trial_2 = data.Routine(
            name='trial_2',
            components=[Fixation, Line1, Line2, Line3, Line4, Probe, key_resp_2],
        )
