...
expName = 'durva_Intentional Binding'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Suhani Jain\\Downloads\\durva_Intentional Binding_lastrun.py',
